...
public class WeekDayView extends View{
    ...
    //上横线颜色
    private int mTopLineColor = Color.parseColor("#3F51B5");//#CCE4F2
    //下横线颜色
    private int mBottomLineColor = Color.parseColor("#3F51B5");
    //周一到周五的颜色
    private int mWeedayColor = Color.parseColor("#ffffff");//#1FC2F3
    //周六、周日的颜色
    private int mWeekendColor = Color.parseColor("#ff0000");//#fa4451
    //线的宽度
